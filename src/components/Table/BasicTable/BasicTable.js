...
const BasicTable = ({ name, title }) => {
  return (
    <>
      <Breadcrumb name={name} title={title} />
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h6 class="mb-0 text-uppercase">Primary Table</h6>
          <hr />
          <div class="card color-table bg-primary">
            <div class="card-body">
          ...
          <h6 class="mb-0 text-uppercase">Danger Table</h6>
          <hr />
          <div class="card color-table bg-danger">
            <div class="card-body">
              <table class="table mb-0">
                <thead>
                  <tr>
          ...
          <h6 class="mb-0 text-uppercase">Success Table</h6>
          <hr />
          ...
          <h6 class="mb-0 text-uppercase">Warning Table</h6>
          <hr />
          ...
          <h6 class="mb-0 text-uppercase">Info Table</h6>
          <hr />
          ...
          <h6 class="mb-0 text-uppercase">Hover able rows</h6>
          <hr />
          <div class="card">
            <div class="card-body">
